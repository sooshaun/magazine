...
class MagazinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post magazines_url, params: { magazine: { classification: @magazine.classification, description: @magazine.description, genre: @magazine.genre, name: @magazine.name, price: @magazine.price } }
    end
  ...
  test "should update magazine" do
    patch magazine_url(@magazine), params: { magazine: { classification: @magazine.classification, description: @magazine.description, genre: @magazine.genre, name: @magazine.name, price: @magazine.price } }
